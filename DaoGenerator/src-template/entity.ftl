...
<#if entity.contentProvider?has_content>
...
<#if entity.interfacesToImplement?has_content> implements <#list entity.interfacesToImplement as ifc>${ifc}<#if ifc_has_next>, </#if></#list></#if> {
<#--
##########################################
########## ContentProviders ##############
##########################################
-->
<#if entity.contentProvider?has_content>
	public static final Uri CONTENT_URI = Uri.withAppendedPath(${contentProvider.className}.AUTHORITY_URI, "${entity.className?uncap_first}");
...
<#if property.javaType == "java.util.Date"> 
		contentValues.put(${entity.classNameDao}.Properties.${property.propertyName?cap_first}.columnName, ${property.propertyName}.getTime());
<#else>
		contentValues.put(${entity.classNameDao}.Properties.${property.propertyName?cap_first}.columnName, ${property.propertyName});
</#if> 
</#list>
...
<#if entity.propertiesPk?has_content && entity.propertiesPk?size != entity.properties?size>
    ...
    public ${entity.className}(<#list entity.propertiesPk as property>${property.javaType} ${property.propertyName}<#if property_has_next>, </#if></#list>) {
